...
class Node:
    ...
    def __init__(self, pair: HashPair) -> None:
...
def search_linked_list(linked_list: LinkedList, key: Any) -> Node | None:
...
def delete_linked_list(linked_list: LinkedList, node: Node | None) -> None:
...
def get_hashtable(hashtable: HashTable, key: Any) -> Any | None:
